<?php
    ...
    if($resultados->num_rows > 0){
        while($row = $resultados->fetch_assoc()) {
            $datos = $row['id_depositos'].",".$row['id_user'].",".$row['nombre'].",".$row['apellido'].",".$row['email'].",".$row['plan'].",".$row['porcentaje'].",".$row['fijo'].",".$row['tiempo'].",".$row['link'].",".$row['fecha'].",".$row['cantidad'].",".$row['archivo'].",".$row['estado'];
            ...
            if($row['estado'] === "4"){
                ...
                $resultadosDepositos .= "<tr><td>".$row['nombre']." ".$row['apellido']."</td><td>".$row['plan']."</td><td>".$row['link']."</td><td>".$row['fecha']."</td><td>".$row['cantidad']."</td><td><a target=\"_blank\" href=\"../controller/uploads/".$row['archivo']."\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-search\" viewBox=\"0 0 16 16\"><path d=\"M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0\"/></svg></a></td>".$estado."</tr>";
